...
def chunks(lst: typing.Tuple[str, ...], n: int) -> typing.Iterator[typing.Tuple[str, ...]]:
...
if __name__ == "__main__":
    ...
    if segment_index is None or input_file is None:
    ...
    if output_index is None or output_alignment_file_base is None or output_format is None:
        sys.exit(f"Error: could not output key {output_key} in parameters {params}")
    ...
    data: typing.Dict[typing.Tuple[str, str], typing.List[typing.Tuple[int, int, str]]] = {}  # dict of list of tuple (x, y, str)
    ...
    if len(skip_pairs) > 0:
        ...
        aggregated_skip_pairs: typing.List[typing.List[typing.Tuple[str, str]]] = []  # list of list of pair names
        current_count = 0
